...
function Entities.prepObj(name,x,y,height,width,color,cls)
  ...
  objects[name].top={objects[name].x+1,objects[name].y-1,objects[name].x+objects[name].w-3,objects[name].y-1}
  objects[name].bottom={objects[name].x+3,objects[name].y+objects[name].h+1,objects[name].x+objects[name].w-3,objects[name].y+objects[name].h+1}
end
...
-------------------------------------RIGHT--------------------------------------------
    ...
    elseif Entities.touchOut(entity,block,"right") and not Entities.touchOut(entity,block,"bottom") then
      if love.keyboard.isDown("left") and objects[entity].class=="player" and not menuOpen then
        Trem.playSound("bump")
      end
...
---------------------------------------TOP---------------------------------------------
    ...
    elseif Entities.touchOut(entity,block,"top") and not Entities.touchOut(entity,block,"right") then
      if love.keyboard.isDown("down") and objects[entity].class=="player" and not menuOpen then
        Trem.playSound("bump")
      end
...
----------------------------------------BOTTOM-----------------------------------------------------------------
    ...
    elseif Entities.touchOut(entity,block,"bottom") and not Entities.touchOut(entity,block,"right") then
      if love.keyboard.isDown("up") and objects[entity].class=="player" and not menuOpen then
        Trem.playSound("bump")
      end
    ...
    elseif Entities.touchOut(entity,block,"bottom") and Entities.touchOut(entity,block,"right") then
      if love.keyboard.isDown("up") and objects[entity].class=="player" and not menuOpen then
        Trem.playSound("bump")
      end
      objects[entity].y=objects[block].y+objects[block].h
...
function Entities.touchOut(ent1,ent2,side)
  ...
  objects[ent2].tdistance=math.sqrt((objects[ent2][side].tp3-objects[ent2][side].tp1)^2 + (objects[ent2][side].tp4-objects[ent2][side].tp2)^2)
  ...
  if side=="left" then
    ...
    objects[ent2][side].tx2=objects[ent2][side].tp1+1
    objects[ent2][side].ty1=objects[ent2][side].tp2
    objects[ent2][side].ty2=objects[ent2][side].tp2+objects[ent2].tdistance
  elseif side=="right" then
    objects[ent2][side].tx1=objects[ent2][side].tp1+1
    objects[ent2][side].tx2=objects[ent2][side].tp1
    objects[ent2][side].ty1=objects[ent2][side].tp2
    objects[ent2][side].ty2=objects[ent2][side].tp2+objects[ent2].tdistance
  elseif side=="top" then
    objects[ent2][side].tx1=objects[ent2][side].tp1
    objects[ent2][side].tx2=objects[ent2][side].tp1+objects[ent2].tdistance
    objects[ent2][side].ty1=objects[ent2][side].tp2
    objects[ent2][side].ty2=objects[ent2][side].tp2+1
  elseif side=="bottom" then
    objects[ent2][side].tx1=objects[ent2][side].tp1
    objects[ent2][side].tx2=objects[ent2][side].tp1+objects[ent2].tdistance
    objects[ent2][side].ty1=objects[ent2][side].tp2+1
    objects[ent2][side].ty2=objects[ent2][side].tp2
  end
